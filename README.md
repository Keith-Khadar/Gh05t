...
- **High Performance**: This is the most expensive pipeline out of the others but it provides out of the box hardware that uses the EEG ESP32 development board. It has the quickest EEG streamline with minimal configuration compared to the other pipelines. 
...
- **Working High Performance Pipeline**: Using a EEG ESP32 development board connected to a ESP32 C6, data can be successfully read and processed for valid information using the OpenBCI GUI. This is a proof of concept to compare our built hardware against. 
