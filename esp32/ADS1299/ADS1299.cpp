...
// Referenced from https://github.com/chipaudette/OpenBCI
// Based off https://github.com/conorrussomanno/ADS1299
// Changed/Extended to ESP32 Arduino Framework
...
void ADS1299::initialize(int _DRDY, int _RST, int _CS, int _FREQ, boolean _isDaisy){
    ...
    // // set as master and enable SPI - ARDUINO UNO FUNCTIONALITY
    // SPCR |= _BV(MSTR);
    // SPCR |= _BV(SPE);
    // //set bit order
